...
function setupEventListeners() {
    ...
    // *** TEST: Enkel window click listener ***
    window.addEventListener('click', () => console.log('!!! Window clicked! (Test Listener) !!!'));
    console.log("Test listener for window lagt til.");
    // *** SLUTT PÅ TEST ***

    function safeAddListener(element, eventType, handler, elementName) { if (element) { element.addEventListener(eventType, handler); } else { console.error(`FEIL: Kunne ikke finne elementet '${elementName}' for å legge til listener!`); } }
    ...
    console.log("--- setupEventListeners FERDIG ---");
}
